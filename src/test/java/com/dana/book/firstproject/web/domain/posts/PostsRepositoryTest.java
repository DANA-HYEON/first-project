package com.dana.book.firstproject.web.domain.posts;
...
public class PostsRepositoryTest {
    ...
    public void 게시글저장_불러오기(){
        ...
        //id값이 있다면update가, 없다면 insert가 실행
        postsRepository.save(Posts.builder()
                .title(title)
                .content(content)
                .author("dada4202@naver.com")
                .build());
    ...
    public void BaseTimeEntity_등록(){
        //given
        LocalDateTime now = LocalDateTime.of(2021,11,24,0,0,0);
        postsRepository.save(Posts.builder()
                .title("title")
                .content("content")
                .author("author")
